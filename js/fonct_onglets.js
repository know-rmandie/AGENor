...
function onglet_04(nom_onglet) {
	anc_onglet_04=onglet(nom_onglet,anc_onglet_04);
	}
function onglet(nom_onglet,anc_onglet) {
	...
	document.getElementById('panneau-'+anc_onglet).className = 'panneau panneau-masque';
	document.getElementById('panneau-'+new_onglet).className = 'panneau panneau-actif';
	return new_onglet;
	}
